Ext.define('Applitest.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Applitest.view.usermanagement.admin.AddUserDetailsViewModel', 'Applitest.model.AddUserDataModel' ],
