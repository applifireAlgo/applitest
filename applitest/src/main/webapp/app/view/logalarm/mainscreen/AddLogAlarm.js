 ...
 * 
 */
Ext.define('Applitest.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Applitest.view.logalarm.mainscreen.AddLogAlarmController',
			'Applitest.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Applitest.view.logalarm.mainscreen.AppAlarmPanel',
