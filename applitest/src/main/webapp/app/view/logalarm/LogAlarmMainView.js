 ...
 * 
 */
Ext.define('Applitest.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Applitest.view.logalarm.LogAlarmMainViewController',
			'Applitest.view.logalarm.tree.LogAlarmTreePanel',
			'Applitest.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
