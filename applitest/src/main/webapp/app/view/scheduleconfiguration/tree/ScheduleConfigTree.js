 ...
 * 
 */
Ext.define("Applitest.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Applitest.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
