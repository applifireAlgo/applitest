Ext.define('Applitest.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Applitest.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Applitest.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Applitest.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Applitest.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Applitest.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Applitest.view.clouddrive.CloudDrive");
    },
