 ...
 * 
 */
Ext.define('Applitest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Applitest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
