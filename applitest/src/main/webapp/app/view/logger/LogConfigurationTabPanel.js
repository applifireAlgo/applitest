...
Ext
		.define(
				'Applitest.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Applitest.view.logger.tabs.details.DetailsTab',
							'Applitest.view.logger.tabs.fileconnector.FileConnectorTab',
							'Applitest.view.logger.tabs.dbconnector.DBConnectorTab',
							'Applitest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Applitest.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Applitest.view.logger.LogConfigurationTabPanelController',
