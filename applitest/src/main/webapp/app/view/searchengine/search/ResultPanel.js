Ext
		.define(
				'Applitest.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Applitest.view.searchengine.search.SearchEngineMainPanelController','Applitest.view.searchengine.search.PanelHeaderField' ,'Applitest.view.searchengine.search.ReportGridView','Applitest.view.searchengine.search.ReportChartView','Applitest.view.searchengine.search.documentView','Applitest.view.searchengine.search.DouMeanView','Applitest.view.googlemaps.map.MapPanel'],
