Ext.define('Applitest.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Applitest.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Applitest.view.console.ConsoleWindow');
