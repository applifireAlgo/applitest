 ...
 */
Ext.define('Applitest.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Applitest.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Applitest.view.fw.component.DateTimePicker(o);
    },
