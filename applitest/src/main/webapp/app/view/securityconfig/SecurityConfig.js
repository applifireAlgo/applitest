 ...
 * 
 */
Ext.define('Applitest.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Applitest.view.securityconfig.SecurityConfigController',
			'Applitest.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
