...
@Repository
@SourceCodeAuthorClass(createdBy = "ashwini.agre@algorhythm.co.in", updatedBy = "ashwini.agre@algorhythm.co.in", versionNumber = "2", comments = "Repository for AddressType Master table Entity", complexity = Complexity.LOW)
