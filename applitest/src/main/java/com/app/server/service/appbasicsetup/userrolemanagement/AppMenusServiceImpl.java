...
@RestController
@SourceCodeAuthorClass(createdBy = "ashwini.agre@algorhythm.co.in", updatedBy = "ashwini.agre@algorhythm.co.in", versionNumber = "2", comments = "Service for AppMenus Master table Entity", complexity = Complexity.LOW)
