...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelDescription("pGqSNDPzRm0YZEDGrQ3ux7kchh0AlWOvWRKH8BPymFnPuaQr53");
        useraccesslevel.setLevelIcon("3YWI1mAyAFOtzXFTiXqWYchGGYY7P9D9rYPsO0fMnUYMoyMY9U");
        useraccesslevel.setLevelName("Konk5TpnfRp6LWg4UOat3hfrAIupiqDtPmMZYgkcl2UdgVmUsa");
        useraccesslevel.setLevelHelp("A6cE544aLrgiEzraG6BukNRsGeMjlWGlEke6pXgBATeTsc9fIW");
        ...
        useraccessdomain.setDomainDescription("Gq9JzMaa3fhwkLjLn1DSlIKs1blgaIKCuQ5ReUWbr3Pg2OySjd");
        useraccessdomain.setDomainName("2sBzCrKgWxVdBdfjBPdPY6OD9U5rFgF9Y4fSJPz2Sxrn0AKzH6");
        useraccessdomain.setDomainIcon("I6cVi9l6BhTYXnfsnhbn5cyBZ8zSQoiCcT5npXCuRJZYLEuJtl");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("afsvgaPaVzvhacnpCDaUS1oFT8x6VJ5bLWLBwM8IvypwXsbCuc");
        ...
        user.setPasswordAlgo("q0VXLB9LFSR1qC9k3hIL5XYtzfvNXdtzxM55J980P2GP5L1Tiv");
        user.setSessionTimeout(1041);
        user.setMultiFactorAuthEnabled(1);
        user.setChangePasswordNextLogin(1);
        user.setGenTempOneTimePassword(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1465803228786l));
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordExpiryDate(new java.sql.Timestamp(1465803228958l));
        user.setIsLocked(1);
        user.setUserAccessCode(16670);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("fIl5CRkzv9WH6KT6TIEoFHhhlET7Xcd9YsSLYz96Pu3Ri8hEPO");
        Question question = new Question();
        question.setQuestionDetails("ghIkEhS2PD");
        question.setLevelid(9);
        question.setQuestion("wT0netnEBbKTCGXkqM0Fu4YSmw7neteWrqQ3VRezQiHGal3zst");
        question.setQuestionIcon("H77YEmlSRPMPBcs2TFn5jwwJVWDBXDWAIjdHRWdhaj2Gzkivvn");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("7fcSwxeD0LYzINkExNnreAIpDUWjOiRmqbrVRy8RlKAn6t5WGC");
        ...
        userdata.setPassword("Qxp51BZp7CqO8THHg3d3QoPLGucmqxupjSNritXGh6umstVxRl");
        userdata.setOneTimePasswordExpiry(3);
        userdata.setPassword("JVym4AzhGft13so6BGj4axv5D1h8yFtGWxAt7pvdjkzyk8po01");
        userdata.setUser(user);
        userdata.setLast5Passwords("YrUFfDrVWWp55QIVagkeeYX73vnUZSUxI3xgFYBQFx4ptzk76j");
        userdata.setOneTimePassword("Rl9LtJazWlyg9Og1MWWs6X1WN5oeWl5k");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1465803229930l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 116406));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "bA0Exam2F2ErnqvXvCmTQheT3RdwcvCGmorWubqsv4HPfuQNSRTqvInk2z4FsXC7g"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 3635));
