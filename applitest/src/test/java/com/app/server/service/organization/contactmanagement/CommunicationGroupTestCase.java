...
public class CommunicationGroupTestCase extends EntityTestCriteria {
    ...
    private CommunicationGroup createCommunicationGroup(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupName("frWTW0bgvsD2ubTRM3097mUrOtyc89DAyTlvSiJAiUTDR8y4DF");
        communicationgroup.setCommGroupDescription("r48kkm4Ng0gsIqg50itbUK5Tu4o5tBDatv2tS2iRq1XtKdix3l");
    ...
    public void test2Update() {
        try {
            ...
            communicationgroup.setCommGroupName("re9ckSWY785z9xeZ3pj1rgKk24ugJIZldREImPfa2xXowVmdVo");
            communicationgroup.setCommGroupDescription("rLxtdfibPOhKWcvIRsaGhzbux2ZRfEdY8lk1RqrycfcFqw35Vi");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commGroupName", "KCGybCE9cmrxxL4QE1joUmMDrq0KpV2H1RVpXdpppjWwJPME7W4EYHnTwR6OfsOTkjiR86TGKeXgQQaWfKyKd8gADYYe6LVjz13s8XfzungZCVTUqexsTh2zAKOSdsYG9"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commGroupDescription", ""));
