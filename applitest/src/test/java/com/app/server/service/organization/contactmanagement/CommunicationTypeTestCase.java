...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupName("AGiNqGynP3CgaEglD7jOkDd8YyvMb8HA80kVTnyTXSdaCMsv24");
        communicationgroup.setCommGroupDescription("sjBjTz3blLNjBlUgVmPbs7oRr87jp7tLZYRkPy79ORuAyslKTl");
        ...
        communicationtype.setCommTypeName("eUDVkWDuE4Toy6FnB586eQ9YhKxp7RjeNrxPv5Qgo1KS3xpVaN");
        communicationtype.setCommTypeDescription("Kd1AZKuCNQqSzhmwscCos4m3RTUslvcBrD6PrGsgNFRjjJnmeG");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeName("Bj8UI4rAwOMrY8AknXwLa4zvcpzzwTjiYklRV90VTqp4HNFvP6");
            communicationtype.setCommTypeDescription("1V2dIzC9orL2WZ6fqPKXrxN0pdAqfPMWGbTeGdH1vPoTV3jkev");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "nfcSBHbGAIJI0La9uevn3CbSjTe2Zl2EBtGoflfxJzJaVMce936VEOvNWXhqbTtAfzzqqiwPV29u0TwdF8hQUvQptQs2TmLmCr6ossZVhRcCjNUMT9KdUplQy5M757GvA"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
